...
public class Program
    {
        ...
        //     {
        //         if(u.Email.ToLower() == email.ToLower() && u.PasswordHash.ToLower() == password.ToLower()) // validate email and password
        //         {
        ...
        //     Console.WriteLine($"Login successful. Welcome {foundUser.FullName}");
        //     Pause();
        ...
        //         Console.Clear();
        //         Console.WriteLine("====== Welcome to Air New Zealand ======");
        //         Console.WriteLine($"====== Kia Ora, {customer.FullName} ====== ");
